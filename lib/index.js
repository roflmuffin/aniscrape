...
(function() {
  ...
  SearchResult = (function() {
    function SearchResult(object) {
      var ref;
      this.seriesName = object.seriesName, this.seriesUrl = object.seriesUrl, this.searchProvider = object.searchProvider, this.isSpecial = (ref = object.isSpecial) != null ? ref : false;
    }
  ...
  Scraper = (function() {
    ...
    Scraper.prototype.fetchSeries = function(searchResult) {
      return needle.getAsync(searchResult.seriesUrl).then(function(resp) {
        ...
        return episodes = episodes.map(function(i, el) {
          var number;
